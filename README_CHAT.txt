...
You are succesfully logged, please Enter an action
 ...
 Для отправки сообщения введите свое имя, имя получателя и текст сообщения, после ввода сообщение отобразится на экране, далее другой пользователь может открыть новою сессию и отправить сообщение вам либо вы можете выйти из чата.
